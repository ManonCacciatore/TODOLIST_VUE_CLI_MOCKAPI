...
<template>
          ...
          <div class="flex items-center gap-3">
            ...
            <input id="t1" type="checkbox" v-model="todo.completed"
              class="h-4 w-4 text-blue-600 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500" />
            <label for="t1" class="flex-1 text-slate-800 cursor-pointer" :class="{'line-through': todo.completed}">
              {{ todo.content }}
            </label>
            <button
              ...
              aria-label="Delete task" title="Delete" @click="onDelete">
              ✕
            </button>
          </div>
